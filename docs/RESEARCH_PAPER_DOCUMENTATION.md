...
**Source:** `ml/03_evaluation.ipynb`, `docs/evaluation_report.json`, `docs/charts/`

**Supporting visualizations** (generated by `ml/03_evaluation.ipynb`):
- `travel_actual_vs_predicted.png` — Travel time: actual vs predicted scatter + residuals
- `travel_mae_by_bucket.png` — Travel time MAE by distance bucket (short/medium/long)
- `pricing_actual_vs_predicted.png` — Pricing: actual vs predicted scatter + residuals
- `pricing_ml_vs_baseline.png` — Pricing: ML vs baseline MAE comparison
- `demand_actual_vs_predicted.png` — Demand: actual vs predicted scatter
- `cross_model_improvement.png` — Cross-model: ML vs baseline improvement % (MAE reduction)
